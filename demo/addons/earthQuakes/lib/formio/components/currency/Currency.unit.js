...
describe('Currency Component', function () {
  ...
  it('Should return value as string properly for multiple values', function (done) {
    _harness["default"].testCreate(_Currency["default"], _fixtures.comp4).then(function (component) {
      component.refs.input = null;
      _powerAssert["default"].equal(component.getValueAsString([100, 200, 300, 500]), '$100.00, $200.00, $300.00, $500.00');
      done();
    })["catch"](done);
  });
});